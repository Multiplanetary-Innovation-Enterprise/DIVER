...
class CommandFactory:
    ...
    def createCommand(self, actionCode:int) -> Command:
        ...
        if self.__rov.getAutonomySystem().getEnabled():
               pass
        else:
        ...
        if actionCode == CaptureImageCommand.getActionCode():
                command = CaptureImageCommand(self.__rov.getVisionSystem())
        elif  actionCode == EstopCommand.getActionCode():
                command = EstopCommand()
        elif actionCode == ChangeAutoCommand.getActionCode():
                command = ChangeAutoCommand(self.__rov.getAutoSystem())
        return command
